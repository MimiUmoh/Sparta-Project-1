...
var promptMessage = document.getElementById("wrong-answer");
...
function goLevel2() {
  ...
  AnswerFour.innerHTML = "You don’t listen to them, you continue your journey anyway";
}
//go level 3
function goLevel3() {
  currentLevel = 3;
  Heading1.innerHTML = "Level Three";
  Heading2.innerHTML = " Slough of Despondent";
  image.src = "PilgrimProgress/levelthree.png";
  question.innerHTML = "You choose to go on The journey regardless of what they were saying to you. Pliable was won over by you argument about the Celestial City, so he chooses to come on the Journey with you. You two are now approaching a slough called the Slough of Despondent—a dark and gloomy place, where many travellers had drowned. What do you decide to do? ";
  answerOne.innerHTML = "Go through the slough and risk drowning";
  answerTwo.innerHTML = "Revert back to where Obstinate and Pliable  caught up with you,  and try to find a short cut";
...
function goLevel6() {
  currentLevel = 6;
  Heading1.innerHTML = " Levl 6";
  Heading2.innerHTML = " Goodwill ";
  image.src = "PilgrimProgress/level6.png";
  question.innerHTML = " So, you decide to not approach the menacing looking castle; but on the opposite side there is a house, which you approach instead.  As you walk towards the door, a few arrows are being aimed at you. Lucky enough, you missed them. You manage to knock on the door. A man opens the door called Goodwill, who informs you that those arrows came from the Dark lord Beelzebub, who owns the castle. You tell Goodwill about your burdens and he tells you that no one can take them off for you. Goodwill then says,” you must keep to the straight and narrow path: it will lead you to a place of deliverance, where your burdens will be lifted off.” After your innocuous and instructive encounter with Goodwill, you continue your journey.";
  answerOne.innerHTML = " ";
  answerTwo.innerHTML = " ";
...
function goLevel8() {
  ...
  question.innerHTML = "You, Christian, walk out of the gate. You see a road fenced on every side. You decide to walk down the road. At the foot of the hill, you pass an open tomb. You then find yourself beneath a way side cross.  As you come under its shadow, you burden begins to fall off. Yes! You are finally free from your burdens!!!  All of a sudden three unusual figures appear from the ether; they are shining. What are they?";
...
function goLevel10() {
  ...
  question.innerHTML = "The shining ones were right, as you left them to continue your journey, you encounter many obstacles and deceptive persons.  Finally, you come to a place, where you hear lions roaring. You look inside, and there, before your eyes, are a den of lions. The porter of the lodge, whose name is Watchful, cries out, “fear not these lions , good fellow, for they are in chains. If you keep to the beam of light they cannot reach you.” You look forward at Watchful, who is almost a mile away from you. In the middle, is a straight beam of light that will guide you towards him. The lions look ferocious. Yes, they are chained up, but what if their chains break? What about this fellow: Watchful? Is he to be trusted?  What should you do? Pick an action.";
...
function goLevel14() {
  ...
  question.innerHTML = " You are directed by the invisible Lord of Creation  towards  a tree: the Tree of  Life. You put the leaves on your wounds, and they heal you.  You leave your army, but you keep your sword.";
  answerOne.innerHTML = "Continue Your Journey ";
  answerTwo.innerHTML = " ";
  answerThree.innerHTML = " ";
  AnswerFour.innerHTML = " ";
...
function goLevel15() {
  ...
  question.innerHTML = " You approach a very dark and pitiful valley—the valley of the Shadow of Death. The smell of rotting flesh permeated the atmosphere leaving you in shock and dismay.  You decide to go in. You see the gates and fire of hell burning brightly in the darkness besides the path.  The sound of doleful  voices infiltrate you soul  leaving you in fear. Do you go back? Please pick an action.";
...
function goLevel22() {
  ...
  image.src = " PilgrimProgress/level22.png";
  question.innerHTML = " Hopeful tells you to not lose hope. The both of you then decide to pray. Strangely enough, you reach inside your pocket and find a key. You try to open the door of the dungeon, and to your surprise, the key works. The two of you walk out of the dungeon, however, you are confronted with another impediment: you have to get through a locked iron gate. You try the key on the gate and it works! However, the Giant suddenly storms out of his abode, near the dungeon! He is really out to get you and Hopeful now. But…the giant starts to twitch and make spontaneous fits—his limbs then begin to fail him; he reacts negatively to the sunlight. The both of you successfully escape.";
  answerOne.innerHTML = " ";
  answerTwo.innerHTML = " Continue Your Journey";
  answerThree.innerHTML = " ";
  AnswerFour.innerHTML = " ";
...
function goLevel23() {
  ...
  question.innerHTML = " The two of you resume your journey on the right path. You then come across some shepherds keeping their flocks. At. The top of the hill, you and Hopeful get a glimpse of the Celestial City.  The shepherds give you and Hopeful two warnings, “beware of the flatterer, and take heed of the enchanted ground.” The two of you then set off on your journey. You both arrive at a place where two paths meet. Then behold, a man dressed in white, resembling one of the Shining Ones, comes to you. He says, “you are close to heaven’s gate, where the Celestial City is. I am going there myself. Come, follow me!” Should you follow him. Please click yes or no?";
  answerOne.innerHTML = "YES ";
  answerTwo.innerHTML = "NO ";
  answerThree.innerHTML = " ";
  AnswerFour.innerHTML = " ";
...
function goLevel25() {
  ...
  image.src = "PilgrimProgress/level25and26.png ";
...
function goLevel27() {
  ...
  question.innerHTML = " Well done, You and Hopeful have finally reached the celestial city! You are greeted by many shinning ones with trumpets. they are singing and Dancing";
  answerOne.innerHTML = " ";
...
function clickButton(button) {
  ...
  //level 8
    ...
    if (button == correctButton) {
      ...
      currentScore = -5;
      alert('Argh, how could you think that!');
    }
  }
  ...
  //Level 9
    ...
    if (button == correctButton) {
      ...
      alert('Please click on the right button!');
    }
  }
  ...
  //levl 21
    ...
    if (button == correctButton) {
      ...
      currentScore -= 10;
      alert('Why would you want to kill yourself?');
    }
  }
  ...
  //level 26
    ...
    if (button == correctButton) {
      ...
      alert('Continue your journey, you are nearly there.');
    }
  }
